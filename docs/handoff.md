...
- F-003 — Direct Entry request/response contract, reshaped to Shaw and Partners' native upstream
  ...
  (`paymentTypeCode`, `paymentDate`, `amount`, plus the `destinationBank*` fields below); organisation-level constants (title, lodgement reference, trace BSB/account, remitter
