...
// Payment Requests (MT101) v9.md §1.5). SourceBankAccountName/SourceBankAccountNo/SourceBankBsb/
// SourceCurrency/SourceAmount are carried by the upstream payload for other purposes - not used in
// this feature's mapping or validation (same treatment IMT gives its own unused fields).
